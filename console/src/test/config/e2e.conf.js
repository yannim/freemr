...
files = [ ANGULAR_SCENARIO, ANGULAR_SCENARIO_ADAPTER, WEBJARS + 'angularjs/1.1.2/angular.js', WEBJARS + 'angularjs/1.1.2/angular-mocks.js', 'src/test/e2e/*.spec.js' ];

// list of files to exclude
exclude = [ 'adapter/require.src.js' ];
...
junitReporter = {
    ...
    outputFile: 'target/surefire-reports/e2e-test-results.xml',
    suite: 'nl.enovation'
};
...
proxies = {
    '/freemr-management-console/': 'http://localhost:8090/freemr-management-console/',
    '/libs/': 'http://localhost:8090/libs/',
    '/index.html': 'http://localhost:8090/index.html',
    '/': 'http://localhost:9080/'
};
